...
class Audio_Model(nn.Module):
    ...
    def forward(self,input_audio):
        ...
        #print (output_layer.shape)
        output_layer = F.relu(self.batch_norm1(self.conv3(output_layer)))
        #print (output_layer.shape)
        output_layer = F.relu(self.batch_norm1(self.conv4(output_layer)))
        #print (output_layer.shape)
        output_layer = F.relu(self.batch_norm1(self.conv5(output_layer)))
        #print (output_layer.shape)
        output_layer = F.relu(self.batch_norm1(self.conv6(output_layer)))
        #print (output_layer.shape)
        output_layer = F.relu(self.batch_norm1(self.conv7(output_layer)))
        #print (output_layer.shape)
        output_layer = F.relu(self.batch_norm1(self.conv8(output_layer)))
        #print (output_layer.shape)
        output_layer = F.relu(self.batch_norm1(self.conv9(output_layer)))
        #print (output_layer.shape)
        output_layer = F.relu(self.batch_norm1(self.conv10(output_layer)))
        #print (output_layer.shape)
        output_layer = F.relu(self.batch_norm1(self.conv11(output_layer)))
        #print (output_layer.shape)
        output_layer = F.relu(self.batch_norm1(self.conv12(output_layer)))
        #print (output_layer.shape)
        output_layer = F.relu(self.batch_norm1(self.conv13(output_layer)))
        output_layer = F.relu(self.batch_norm1(self.conv14(output_layer)))
        output_layer = F.relu(self.batch_norm2(self.conv15(output_layer)))
...
class Audio_Visual_Fusion(nn.Module):
    ...
    def __init__(self,num_person=2):

...
class TrainMetricGAN(GanSystem):
    ...
    def training_step(self, batch, batch_nb, optimizer_idx):
        ...
        if optimizer_idx == 0:
            ...
            est_true_labels = self.discriminator(inputs, targets)
            true_loss = self.d_loss(inputs, targets, targets,
        ...
        if optimizer_idx == 1:
            ...
            est_labels = self.discriminator(estimates, targets)

...
def test_xcorr(seq_len_input, seq_len_ref, batch_size, n_mics, normalized):
    target = torch.rand((batch_size, n_mics, seq_len_input))
    ref = torch.rand((batch_size, n_mics, seq_len_ref))
